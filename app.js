...
const STRINGS = {
  en: {
    ...
    "work.lede":
      "No install, no sign-up. Ten of the eleven open in your browser the moment you click. The eleventh is private, so it gets a written case study instead.",
  ...
  de: {
    ...
    "work.lede":
      "Keine Installation, keine Anmeldung. Zehn der elf öffnen sich mit einem Klick im Browser. Das elfte ist ein privates Repository, dafür gibt es eine ausgeschriebene Fallstudie.",
